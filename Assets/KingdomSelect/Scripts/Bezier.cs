...
namespace KingdomSelect
{
    ...
    public class Bezier : MonoBehaviour
    {
        ...
        [Range(0, 1)] public float distanceAmount = 1;
        ...
        private void SetMidPoint(Transform nextPoint)
        {
            ...
            pivot.transform.localEulerAngles = new Vector3(
                (transform.localEulerAngles.x + nextPoint.localEulerAngles.x) / 2,
        ...
        private void DrawQuadraticCurve()
        {
            ...
            for (int i = 0; i < numPoints; i++)
            {
                ...
                positions[i] =
                    CalculateQuadraticBezierPoint(t, points[0].position, points[1].position, points[2].position);
            }
